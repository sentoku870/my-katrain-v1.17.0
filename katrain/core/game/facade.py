...
from katrain.core import analysis as analysis_pkg
...
class Game(BaseGame):
    ...
    def _find_node_by_move_number(self, move_number: int) -> GameNode | None:
        ...
        """
        for node in analysis_pkg.iter_main_branch_nodes(self):
    ...
    def get_important_move_evals(
        ...
        *,
        ...
        - Phase 270: ``user_weak_tags`` parameter was removed along
          with the Curator weak-tag hint. The pick call no longer
          receives a weak-tag boost.
        """
        snapshot = self.build_eval_snapshot()
        ...
        important_moves = analysis_pkg.pick_important_moves(
            snapshot,
            level=level,
            recompute=True,
        )
    ...
    def build_important_moves_report(
        ...
        *,
        ...
        - analysis_pkg.pick_important_moves の結果に基づく
    ...
    def log_important_moves_for_debug(
        ...
        *,
        ...
        if not important_moves:
            settings = analysis_pkg.IMPORTANT_MOVE_SETTINGS_BY_LEVEL.get(
                level,
                analysis_pkg.IMPORTANT_MOVE_SETTINGS_BY_LEVEL[analysis_pkg.DEFAULT_IMPORTANT_MOVE_LEVEL],
            )
            self.katrain.log(
    ...
    def _compute_important_moves(
        ...
        return self.navigator._compute_important_moves(max_moves=max_moves, color_filter=color_filter)
    ...
    def get_important_move_numbers(
        ...
        return self.navigator.get_important_move_numbers(max_moves=max_moves, color_filter=color_filter)
    ...
    def get_next_important_node(
        ...
        return self.navigator.get_next_important_node(max_moves=max_moves, color_filter=color_filter)
    ...
    def get_prev_important_node(
        ...
        return self.navigator.get_prev_important_node(max_moves=max_moves, color_filter=color_filter)
    ...
    def jump_to_next_important_move(
        ...
        return self.navigator.jump_to_next_important_move(max_moves=max_moves, color_filter=color_filter)
    ...
    def jump_to_prev_important_move(
        ...
        return self.navigator.jump_to_prev_important_move(max_moves=max_moves, color_filter=color_filter)
