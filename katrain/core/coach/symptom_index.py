...
_SYMPTOMS: tuple[Symptom, ...] = (
    ...
    Symptom(
        ...
        related_lexicon_ids=("time_management", "endgame_sente_value"),
        related_hint_category=None,
    ...
    Symptom(
        ...
        related_lexicon_ids=("time_management", "counting"),
        related_hint_category=None,
        difficulty_range=(CoachMode.INTERMEDIATE, CoachMode.EXPERT),
        auto_detected=False,
    ...
    Symptom(
        ...
        related_lexicon_ids=("post_game_review", "ai_overload"),
        related_hint_category=None,
        difficulty_range=(CoachMode.INTERMEDIATE, CoachMode.EXPERT),
        auto_detected=False,
    ...
    Symptom(
        ...
        related_lexicon_ids=("ai_overload", "post_game_review"),
        related_hint_category=None,
        difficulty_range=(CoachMode.BEGINNER, CoachMode.EXPERT),
        auto_detected=False,
    ...
    Symptom(
        ...
        related_lexicon_ids=("tilt_recovery", "mental_state"),
        related_hint_category=None,
        difficulty_range=(CoachMode.BEGINNER, CoachMode.EXPERT),
    ...
    Symptom(
        ...
        related_lexicon_ids=("mental_state", "tilt_recovery"),
        related_hint_category=None,
        difficulty_range=(CoachMode.BEGINNER, CoachMode.EXPERT),
        auto_detected=False,
