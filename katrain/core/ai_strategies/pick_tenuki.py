"""TenukiStrategy - far-from-last-move pick strategy.

Phase 172: Extracted from ``katrain.core.ai_strategies.pick`` for family
organization. Inverse of LocalStrategy: prefers moves far from the previous
stone. Falls back to ``WeightedStrategy`` when there is no previous move.
"""
