...
option values, key properties, and ELO calibration grids used by the
AI subsystem live here.
"""
...
__all__ = [
    ...
    "AI_DEFAULT", "AI_HANDICAP", "AI_SCORELOSS", "AI_WEIGHTED", "AI_JIGO",
    "AI_ANTIMIRROR", "AI_POLICY", "AI_PICK", "AI_LOCAL", "AI_TENUKI",
    "AI_INFLUENCE", "AI_TERRITORY", "AI_RANK", "AI_SIMPLE_OWNERSHIP",
    "AI_SETTLE_STONES", "AI_HUMAN", "AI_PRO",
    # Aggregations
    "AI_CONFIG_DEFAULT", "AI_STRATEGIES_ENGINE", "AI_STRATEGIES_PICK",
    "AI_STRATEGIES_POLICY", "AI_STRATEGIES", "AI_STRATEGIES_RECOMMENDED_ORDER",
    "AI_STRENGTH",
    # Statistics
    "AI_ACCURACY_DECAY_BASE", "AI_PASS_LOSS_THRESHOLD", "AI_ENDGAME_FILL_RATIO_DEFAULT",
    # Options
    "AI_OPTION_VALUES", "AI_KEY_PROPERTIES",
    # ELO calibration
    "CALIBRATED_RANK_ELO", "AI_WEIGHTED_ELO", "AI_SCORELOSS_ELO",
