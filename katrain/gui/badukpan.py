...
# Phase D (P3): control classes extracted to badukpan_controls.py
# for clearer separation of concerns. Re-exported here so
# existing imports (from katrain.gui.badukpan import) keep working.
from katrain.gui.badukpan_controls import (  # noqa: E402,F401
    AnalysisControls,
    AnalysisDropDown,
    BadukPanControls,
    MyKatrainDropDown,
