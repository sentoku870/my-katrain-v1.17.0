...
# =============================================================================
# Phase 42-A: Backward compatibility re-exports from katrain.core.batch
# =============================================================================
# These symbols are now defined in katrain.core.batch.models and helpers.
# Re-export them here so existing code continues to work.
...
# =============================================================================
# NOTE: The following sections previously contained local implementations.
# They are now imported from katrain.core.batch (Phase 42-A).
# Removed local definitions:
#   - choose_visits_for_sgf() -> core.batch.helpers
#   - _get_canonical_loss() -> core.batch.helpers (as get_canonical_loss)
#   - DEFAULT_TIMEOUT_SECONDS -> core.batch.helpers
#   - parse_timeout_input() -> core.batch.helpers
#   - _safe_write_file() -> core.batch.helpers (as safe_write_file)
#   - ENCODINGS_TO_TRY -> core.batch.helpers
#   - read_sgf_with_fallback() -> core.batch.helpers
#   - parse_sgf_with_fallback() -> core.batch.helpers
#   - has_analysis() -> core.batch.helpers
#   - collect_sgf_files_recursive() -> core.batch.helpers
#   - collect_sgf_files() -> core.batch.helpers
#   - wait_for_analysis() -> core.batch.helpers
#   - WriteError, BatchResult -> core.batch.models
# =============================================================================
...
# NOTE: WriteError and BatchResult are now imported from katrain.core.batch.models
...
# NOTE: _WINDOWS_RESERVED, _sanitize_filename, _get_unique_filename, _normalize_player_name
# are now imported from katrain.core.batch.helpers (Phase 42-A)

# Generic player names to skip (kept local as used only by _extract_players_from_stats)
