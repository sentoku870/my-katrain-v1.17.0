"""Phase-mistake aggregation and streak-detection tests (Phase E-1).

Extracted from tests/test_karte_structure.py. Covers
:func:`aggregate_phase_mistake_stats`, :func:`classify_game_phase`,
:func:`detect_mistake_streaks`, and the related MoveEval defaults.
"""
