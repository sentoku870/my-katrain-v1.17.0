...
* Make sure you have a python installation, I will assume Anaconda (Python 3.13 or later), available [here](https://www.anaconda.com/products/individual#download-section).
...
If you have a working Python 3.13 or later available, you should be able to simply:
...
It assumes you have a working Python 3.13+ installation.
