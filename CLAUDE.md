...
**最新の変更（2026-01-27）:**
- Phase 70 完了（複雑関数リファクタリング - analyze_extra分割、_compute_important_moves最適化）
- テスト総数: 2749件
